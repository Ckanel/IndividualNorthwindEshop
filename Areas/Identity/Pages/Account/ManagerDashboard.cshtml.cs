...
namespace IndividualNorthwindEshop.Areas.Identity.Pages.Account
{
    ...
    public class ManagerDashboardModel : PageModel
    {
        ...
        //                {
        //                    _logger.LogWarning("Error occurred while creating user {Email}: {ErrorDescription}", Input.Email, error.Description);
        //                    Debug.WriteLine($"Error occurred while creating user {Input.Email}: {error.Description}");
