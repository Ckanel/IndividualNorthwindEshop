...
namespace IndividualNorthwindEshop.Migrations.UserRelationships
{
    ...
    [Migration("20240325203351_AddHandlingStartTimeToOrders")]
    partial class AddHandlingStartTimeToOrders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.AlphabeticalListOfProduct", b =>
                {
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.CategorySalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.CurrentProductList", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.CustomerAndSuppliersByCity", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.CustomerDemographic", b =>
                {
                    b.Property<string>("CustomerTypeId")
                        .HasMaxLength(10)
                        .HasColumnType("nchar(10)")
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.Invoice", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.OrderDetailsExtended", b =>
                {
                    b.Property<float>("Discount")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.OrderSubtotal", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.OrdersQry", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.ProductSalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.ProductsAboveAveragePrice", b =>
                {
                    b.Property<string>("ProductName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.ProductsByCategory", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.QuarterlyOrder", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.Region", b =>
                {
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.SalesByCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int")
                        .HasColumnName("CategoryID");
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.SalesTotalsByAmount", b =>
                {
                    b.Property<string>("CompanyName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.Shipper", b =>
                {
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.SummaryOfSalesByQuarter", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.SummaryOfSalesByYear", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.Territory", b =>
                {
                    b.Property<string>("TerritoryId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("CustomerCustomerDemo", b =>
                {
                    b.HasOne("IndividualNorthwindEshop.Models.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .IsRequired()
                        .HasConstraintName("FK_CustomerCustomerDemo_Customers");

                    b.HasOne("IndividualNorthwindEshop.Models.CustomerDemographic", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeTerritory", b =>
                {
                    b.HasOne("IndividualNorthwindEshop.Models.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .IsRequired()
                        .HasConstraintName("FK_EmployeeTerritories_Employees");

                    b.HasOne("IndividualNorthwindEshop.Models.Territory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.Employee", b =>
                {
                    b.HasOne("IndividualNorthwindEshop.Models.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.Order", b =>
                {
                    ...
                    b.HasOne("IndividualNorthwindEshop.Models.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.OrderDetail", b =>
                {
                    b.HasOne("IndividualNorthwindEshop.Models.Order", "Order")
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.Product", b =>
                {
                    b.HasOne("IndividualNorthwindEshop.Models.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("FK_Products_Categories");

                    b.HasOne("IndividualNorthwindEshop.Models.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("IndividualNorthwindEshop.Models.Territory", b =>
                {
                    b.HasOne("IndividualNorthwindEshop.Models.Region", "Region")
